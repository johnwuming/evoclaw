...
## 4b. 阶段B：窗口指标复算（2026-08-21 10:3x，HP python 从 full_nav 复算，终点截 2026-08-13）
口径 = a9_common.compute_metrics 逐位复刻（ann=总收益^(1/years365.25)-1；MDD=cummax；sharpe×√252）
| run | W-full ann/mdd | W-crowd ann/mdd | W-crisis ret/mdd | W-holdout ann/mdd |
| g0_orig(基准) | 0.223936/-0.335542 | 0.139497/-0.161286 | -0.035697/-0.095673 | 0.257774/-0.161286 |
| g0_lam0 | 同 g0_orig 逐位 | 同 | 同 | 同 |
| t1_f1_l05 | 0.222949/-0.335542 | 0.136634/-0.161275 | -0.035557/-0.090690 | 0.256383/-0.161275 |
| t2_f1_l10 | 0.222777/-0.335542 | 0.136136/-0.161273 | -0.032772/-0.081173 | 0.251665/-0.161273 |
| t3_f2_l05 | 0.222080/-0.335542 | 0.134120/-0.161265 | -0.035525/-0.090670 | 0.257604/-0.161265 |
| t4_f2_l10 | 0.221396/-0.335542 | 0.132144/-0.161258 | -0.032735/-0.081138 | 0.249628/-0.161258 |
注：g0_orig 新数据复算 ann 0.2239 与在役旧产物 0.2239 一致、crisis MDD -9.57% 与在役一致 → 基准复现预登记参照系 OK
四门（门槛 R-252 §五 一字不改）：
- G1 crisis MDD≥-8.57%：T1 FAIL(-9.07%) T2 PASS(-8.12%) T3 FAIL(-9.07%) T4 PASS(-8.11%)
- G2 crowd ann≥12.44%：全 PASS（13.66/13.61/13.41/13.21%）
