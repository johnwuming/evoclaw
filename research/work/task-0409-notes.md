...
8. [02:35] 修复后正式结果（W1 正确配对 + 上市120日过滤, R251_DONE 118.8s）:
   - sue_std: IC .0117 ICIR .115 t 1.78 (240月) | sue_pct: IC .0063 ICIR .074 t 1.15 → 未达线
   - 新鲜度: 0-2月 IC .0266 ICIR .261 (t≈3.3); 3-5月转负; 6+月 -.0066 → 事件窗信号, 非持久因子
   - 冗余: vs roe_ttm ρ=.599(p90 .648 触0.6线); IC序列相关 .886; vs np_yoy ρ=.193
   - 年度: 12正9负, 近三年无改善
9. [02:36] 独立复算验证通过: 2019-04 -0.01799/3111, 2021-10 -0.04521/3713, 2025-06 -0.01080/4877 全等
10. [02:37] 报告写入 05-量化投资/R-251-SUE财报事件因子IC画像.md (4703B); 完成回报写入 .task-completions.jsonl
