...
[14:23] 第四次运行（clean）判门终局数字落盘：
- 因子层全过：G0 PASS(n232 mean+0.0128 rel_dev0.022% corr1.0)；G1 PASS(mixed n147 +0.0266/0.359/t4.35，与铏+0.0152同号)；T2未触发(strict n133 +0.0249/0.334/t3.85 同号双强)
