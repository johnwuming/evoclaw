...
### 阶段3 收口 + 阶段4/5 (2026-08-17)
- 正式回测全部完成 (A5_NONE_DONE 881.8s, EQUIV_OK 全过)
- v4a_gqe1: locked 10.74%/-31.31%/0.744 | v4b_mve1: 12.42%/-28.99%/0.840
- v4c_gqpeg: 10.36%/-33.68%/0.723 | v4d_gqg1: 11.59%/-29.67%/0.796 | v4e_gqg1x: 19.09%/-71.69%/0.751
- 五门禁 (n_trials 61→67): v4b_mve1 六门全PASS(pending), v4d_gqg1 六门全PASS(pending)
  v4a/v4c/v4e REJECT (g4_dsr FAIL: 0.934/0.923/0.547)
- 战役目标 25%/-20%/1.2: 全部未达; 0 activate; decision-log D-20260816-043 a5_batch_closeout
- registry v4a-v4e 候选入库; ledger IT-A5-01..05 (features字段); results/a5_* 57文件
- 报告 results/a5-iteration-report.md 8404B 已部署
- 结论: 成长x质量无alpha(IC+回测双证); E1护栏压MDD 0.87pp但年化-2.7pp; Calmar不变式第三次验证;
  MDD≤20%与ann≥25%当前宇宙+择时框架无交点 → 需换赛道(期权对冲/可转债轮动/现金增强)
- 技术备注: HP env scipy ABI间歇损坏(numpy2.4.6/scipy1.17.1), 重试规避; 用前自检
